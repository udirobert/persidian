...
export const PRODUCTS: BaseProject[] = [
  ...
  },
  {
    ...
    problemStat: "~40%",
    problemLabel: "ZEC market drop after Orchard soundness bug disclosure (May–June 2026)",
    iconName: "pulse",
  ...
  },
  {
    ...
    problemStat: "$12.9M",
    problemLabel: "average annual cost of poor data quality (Gartner 2020 enterprise survey)",
    iconName: "watcher",
  ...
  },
  {
    ...
    problemStat: "~30 hrs",
    problemLabel: "per week grant professionals lose to manual grant lifecycle admin (shadow work)",
    iconName: "weave",
    shot: "/shots/weft.png",
    bg: "#f4f8f7",
    fg: "#1c211f",
